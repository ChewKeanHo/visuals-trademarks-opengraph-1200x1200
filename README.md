# Meta's OpenGraph (OpenGraph) Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The OpenGraph Trademarks Logo. They did not publish any trademark guideline left
alone supplying the required material files for it. The preferred version is
...
This project re-draws OpenGraph Trademarks Logo specifically for 1200x1200 size.
...
Since OpenGraph did not publish its brand and trademark guideline, **it is
assumed standard trademarks laws applied to avoid any unwanted legal
implications**.

While not specified by OpenGraph, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Meta's OpenGraph (OpenGraph) Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-opengraph-1200x1200
UUID: 56BCBF33-7A68-4988-A187-EF4AFCA2A793
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-20
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-opengraph-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH META'S OPENGRAPH TRADEMARK REQUIREMENTS**.
>
